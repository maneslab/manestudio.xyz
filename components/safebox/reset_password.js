...
class ResetPassword extends React.Component {
    ...
    render() {
        ...
        return <div>
            <h2 className='h2'>{t('reset password')}</h2>
                ...
                {({ errors, touched }) => (
                    ...
                    <div className="p-4 md:p-6">
                        ...
                        <div className="form-submit flex justify-end mt-4">
                            <Button loading={is_adding_safebox} className="btn btn-primary" type="submit">{t("set password")}</Button>
                        </div>
